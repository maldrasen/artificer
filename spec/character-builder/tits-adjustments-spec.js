describe('Adjustments - Tits', function() {
  ...
  it ('gives small tits', function(done) {
    CharacterBuilder.build({ species:'elf', gender:'female', triggers:['small-tits'] }).then(character => {
  ...
  it ('gives big tits', function(done) {
    CharacterBuilder.build({ species:'elf', gender:'female', triggers:['big-tits'] }).then(character => {
      character.getTits().then(tits => {
  ...
  it ('gives monster tits', function(done) {
    CharacterBuilder.build({ species:'elf', gender:'female', triggers:['monster-tits'] }).then(character => {
      character.getTits().then(tits => {
