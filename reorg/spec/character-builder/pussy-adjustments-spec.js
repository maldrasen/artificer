describe('Adjustments - Pussy', function() {
  ...
  it ('gives a big pussy', function(done) {
    SpecHelper.buildJada({},['big-pussy']).then(character => {
  ...
  it ('gives a monster pussy', function(done) {
    SpecHelper.buildJada({},['monster-pussy']).then(character => {
      character.getPussy().then(pussy => {
  ...
  it ('gives a big clit', function(done) {
    SpecHelper.buildJada({},['big-clit']).then(character => {
      character.getPussy().then(pussy => {
  ...
  it ('gives a monster clit', function(done) {
    SpecHelper.buildJada({},['monster-clit']).then(character => {
      character.getPussy().then(pussy => {
  ...
  it ('gives big labia', function(done) {
    SpecHelper.buildJada({},['big-labia']).then(character => {
      character.getPussy().then(pussy => {
  ...
  it ('gives monster labia', function(done) {
    SpecHelper.buildJada({},['monster-labia']).then(character => {
      character.getPussy().then(pussy => {
  ...
  it ('gives a dog pussy', function(done) {
    SpecHelper.buildJada({},['dog-pussy']).then(character => {
      character.getPussy().then(pussy => {
  ...
  it ('gives a horse pussy', function(done) {
    SpecHelper.buildJada({},['horse-pussy']).then(character => {
      character.getPussy().then(pussy => {
