global.TrainingExperience = (function() {

  // If the character has the aspect alreay we add the value to the aspect.
  // Because their aspect strength may go up a level here we might also include
...
// ========================================================================
// Old Version, but sexual experience will still be based on consent levels
// and such, so add this once we start working on the sex training.
