Abuser.MouthAbuser = (function() {
  ...
  function describeBlight(injury, details) { return `(TODO: Describe Mouth Blight - ${injury.level})`; }
  function describeBurn(injury, details)   { return `(TODO: Describe Mouth Burn - ${injury.level})`; }
  function describeCut(injury, details)    { return `(TODO: Describe Mouth Cut - ${injury.level})`; }
  function describePierce(injury, details) { return `(TODO: Describe Mouth Pierce - ${injury.level})`; }
  function describeRip(injury, details)    { return `(TODO: Describe Mouth Rip - ${injury.level})`; }
  function describeSmash(injury, details)  { return `(TODO: Describe Mouth Smash - ${injury.level})`; }
