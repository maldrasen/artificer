Abuser.AnusAbuser = (function() {
  ...
  function describeBlight(injury, details) { return `(TODO: Describe Anus Blight - ${injury.level})`; }
  function describeBurn(injury, details)   { return `(TODO: Describe Anus Burn - ${injury.level})`; }
  function describeCut(injury, details)    { return `(TODO: Describe Anus Cut - ${injury.level})`; }
  function describePierce(injury, details) { return `(TODO: Describe Anus Pierce - ${injury.level})`; }
  function describeRip(injury, details)    { return `(TODO: Describe Anus Rip - ${injury.level})`; }
  function describeSmash(injury, details)  { return `(TODO: Describe Anus Smash - ${injury.level})`; }
