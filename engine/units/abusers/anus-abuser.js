Abuser.AnusAbuser = (function() {
  ...
  async function describeBlight(injury, details) { return `(TODO: Describe Anus Blight - ${injury.level})`; }
  async function describeBurn(injury, details)   { return `(TODO: Describe Anus Burn - ${injury.level})`; }
  async function describeCut(injury, details)    { return `(TODO: Describe Anus Cut - ${injury.level})`; }
  async function describePierce(injury, details) { return `(TODO: Describe Anus Pierce - ${injury.level})`; }
  async function describeRip(injury, details)    { return `(TODO: Describe Anus Rip - ${injury.level})`; }
  async function describeSmash(injury, details)  { return `(TODO: Describe Anus Smash - ${injury.level})`; }
