Abuser.PussyAbuser = (function() {
  ...
  async function describeBlight(injury, details) { return `(TODO: Describe Pussy Blight - ${injury.level})`; }
  async function describeBurn(injury, details)   { return `(TODO: Describe Pussy Burn - ${injury.level})`; }
  async function describeCut(injury, details)    { return `(TODO: Describe Pussy Cut - ${injury.level})`; }
  async function describePierce(injury, details) { return `(TODO: Describe Pussy Pierce - ${injury.level})`; }
  async function describeRip(injury, details)    { return `(TODO: Describe Pussy Rip - ${injury.level})`; }
  async function describeSmash(injury, details)  { return `(TODO: Describe Pussy Smash - ${injury.level})`; }
