Abuser.PussyAbuser = (function() {
  ...
  function describeBlight(injury, details) { return `(TODO: Describe Pussy Blight - ${injury.level})`; }
  function describeBurn(injury, details)   { return `(TODO: Describe Pussy Burn - ${injury.level})`; }
  function describeCut(injury, details)    { return `(TODO: Describe Pussy Cut - ${injury.level})`; }
  function describePierce(injury, details) { return `(TODO: Describe Pussy Pierce - ${injury.level})`; }
  function describeRip(injury, details)    { return `(TODO: Describe Pussy Rip - ${injury.level})`; }
  function describeSmash(injury, details)  { return `(TODO: Describe Pussy Smash - ${injury.level})`; }
