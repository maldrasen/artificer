Abuser.CockAbuser = (function() {
  ...
  function describeBlight(injury, details) { return `(TODO: Describe Cock Blight - ${injury.level})`; }
  function describeBurn(injury, details)   { return `(TODO: Describe Cock Burn - ${injury.level})`; }
  function describeCut(injury, details)    { return `(TODO: Describe Cock Cut - ${injury.level})`; }
  function describePierce(injury, details) { return `(TODO: Describe Cock Pierce - ${injury.level})`; }
  function describeRip(injury, details)    { return `(TODO: Describe Cock Rip - ${injury.level})`; }
  function describeSmash(injury, details)  { return `(TODO: Describe Cock Smash - ${injury.level})`; }
