Summoner.OralSegments.CockPositioning = (function() {
  ...
  // Gently position a character to give oral sex on a cock. This will depend
  // on the player's position, the character's height, furniture in the room,
  // and various other factors and aspects.
  //
  ...
  async function positionGently(storyTeller) {
    ...
    if (heightDifference.name == 'tinyCharacter') {
      if (playerPosition == 'laying') { await positionGentlyWhenSmallLaying(storyTeller); }
      if (playerPosition == 'sitting') { await positionGentlyWhenSmallSitting(storyTeller); }
      if (playerPosition == 'standing') { await positionGentlyWhenTinyStanding(storyTeller); }
    }
    if (heightDifference.name == 'smallCharacter') {
      if (playerPosition == 'laying') { await positionGentlyWhenSmallLaying(storyTeller); }
      if (playerPosition == 'sitting') { await positionGentlyWhenSmallSitting(storyTeller); }
      if (playerPosition == 'standing') { await positionGentlyWhenSmallStanding(storyTeller); }
    }
  ...
  //
  async function positionGentlyWhenTinyStanding(storyTeller) {
