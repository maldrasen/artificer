let names = [
 ...
 { name:"Paints-With-Dreams", aspects:['peaceful.2'], triggers:['magical'], restriction:'female' },
 { name:"Picks-A-Flower", aspects:['peaceful.3'], restriction:'female' },
 ...
 { name:"Sings-Her-Sorrows", aspects:['gentle','peaceful'], restriction:'female' },
 { name:"Sings-In-The-Rain" },
 { name:"Sings-Like-Thunder", triggers:['magical']},
 { name:"Sings-To-The-Deep", aspects:['peaceful']},
 { name:"Sings-To-The-Sun", aspects:['peaceful']},
 ...
 { name:"Sleeps-All-Day", aspects:['peaceful']},
 { name:"Slim-Pickins" },
 ...
 { name:"Smokes-A-Pipe", aspects:['peaceful.3']},
 { name:"Smokes-The-Weeds", aspects:['peaceful.3']},
 { name:"Smooth-As-Wind", aspects:['peaceful.2']},
 ...
 { name:"Swims-In-The-Sky", aspects:['peaceful'], triggers:['magical']},
 { name:"Swings-A-Sword", aspects:['violent']},
 { name:"Takes-A-Rabbit" },
 { name:"Takes-Her-Time", aspects:['peaceful'], restriction:'female' },
 { name:"Takes-In-Light", aspects:['peaceful']},
 { name:"Takes-The-Shot" },
 { name:"Talks-To-Himself", restriction:'male' },
 { name:"Talks-To-Shadows" },
 { name:"Talks-To-Trees", aspects:['peaceful']},
 { name:"Talks-Too-Much" },
 { name:"Tames-A-Fox", aspects:['peaceful']},
 { name:"Tans-A-Hide" },
 ...
 { name:"The-Color-Of-A-Dream", aspects:['peaceful.2'], restriction:'female' },
 ...
 { name:"Thoughts-Of-The-Wind", aspects:['peaceful'], triggers:['smart']},
 ...
 { name:"Unlocks-A-Door" },
 { name:"Waits-For-Spring", aspects:['peaceful.2']},
 { name:"Walks-In-Rain" },
 { name:"Walks-In-Shadow" },
 { name:"Walks-In-The-Deep", aspects:['peaceful']},
 { name:"Walks-In-The-Forest", aspects:['peaceful']},
 { name:"Walks-On-A-Cloud", aspects:['peaceful.2'], triggers:['magical']},
 { name:"Walks-On-Thin-Ice" },
 { name:"Walks-On-Water", triggers:['magical']},
 { name:"Walks-Through-Fog", aspects:['peaceful']},
 ...
 { name:"Watches-The-Flames", aspects:['peaceful']},
 { name:"Watches-The-Stars", aspects:['peaceful'], triggers:['smart']},
 { name:"Waves-In-The-Water", aspects:['peaceful.2']},
 { name:"Weaves-A-Basket", aspects:['peaceful']},
 { name:"Whats-Her-Face", restriction:'female' },
 { name:"Whats-His-Face", restriction:'male' },
 { name:"Wind-On-Her-Scales", aspects:['peaceful'], triggers:['beautiful'], restriction:'female' },
