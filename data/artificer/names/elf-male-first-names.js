let names = [
  ...
  { name:"Thanatos" },
  { name:"Thaniel" },
  { name:"the Cum Fountain", triggers:['monster-balls']},
  { name:"the Deformed", triggers:['ugly']},
  { name:"the Drafthorse", triggers:['tall','strong','monster-cock','horse-cock','big-balls']},
  { name:"the Elephant", triggers:['ugly','monster-cock']},
