let names = [
  ...
  { name:"Assfister", aspects:['anal-lover.2','stretcher.2']},
  { name:"Assfucker", aspects:['anal-lover.3']},
  { name:"Asskicker", aspects:['violent']},
  { name:"Asskisser", aspects:['violent']},
  { name:"Asspacker", aspects:['anal-lover.3']},
  { name:"Assripper", aspects:['anal-lover.3','stretcher.2'], triggers:['monster-cock'], restriction:'has-cock'},
  { name:"Asswiper", aspects:['anal-lover.2','revolting']},
  ...
  { name:"Butsecks", aspects:['anal-lover.3']},
  ...
  { name:"Cumshitter", aspects:['androphilic','cum-lover.3','anal-lover.3','revolting']},
  ...
  { name:"Flavored" },
  { name:"Fuckass", aspects:['anal-lover.3']},
  { name:"Fuckfucker" },
  { name:"Fuckitall" },
  ...
  { name:"Sex Machine", aspects:['pussy-lover.3','anal-lover.3']},
