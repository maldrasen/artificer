...
Description.buildNipples({ requires:['species-furry','nipples-size-big'],
...
Description.buildNipples({ requires:['nipples-shape-puffy'],
...
Description.buildNipples({ requires:['tits-size-below-average','nipples-shape-puffy'],
