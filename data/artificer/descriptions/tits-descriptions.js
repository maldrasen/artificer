...
Description.buildTits({ requirements:['tits-shape-perky'], conditions:['species-scaven'],
...
Description.buildTits({ requirements:['tits-shape-conical'], conditions:['species-scaven'],
...
Description.buildTits({ requirements:['tits-size-tiny'], conditions:['species-scaven'],
...
Description.buildTits({ requirements:['tits-size-tiny','nipples-size-huge'], conditions:['species-scaven'],
