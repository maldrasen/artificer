...
Description.buildTits({ requires:['tits-size-tiny'],
...
Description.buildTits({ requires:['tits-shape-perky'], conditions:['species-scaven'],
...
Description.buildTits({ requires:['tits-shape-conical'], conditions:['species-scaven'],
...
Description.buildTits({ conditions:['species-scaven'],
...
Description.buildTits({ conditions:['species-scaven','tits-size-zero'],
  d: `{{C::character.firstName}} has a completely flat chest. {{C::gender.His}} chest is lean and muscular and could
...
Description.buildTits({ requires:['tits-size-tiny'], conditions:['species-scaven'],
...
Description.buildTits({ requires:['tits-size-tiny','nipples-size-huge'], conditions:['species-scaven'],
