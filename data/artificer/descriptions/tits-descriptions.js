Description.buildTits({ requirements: [],
  d: `{{C::character.firstName}} has {{C::tits.sizeShape}} {{tits}}.`,
});

Description.buildTits({ requirements: [],
  d: `{{C::character.firstName's}} {{tits}} are {{C::tits.sizeAndShape}}.`,
});

// --- Size Specific ---

Description.buildTits({ requirements: ['tits-size-zero'],
...
Description.buildTits({ requirements: ['species-rat','tits-size-zero'],
  d: `{{C::character.firstName}} has a completely flat chest. {{C::gender.His}} chest is lean and muscular and could
...
Description.buildTits({ requirements: ['species-rat','tits-size-tiny'],
