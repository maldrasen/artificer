  ...
  stages:[
    {
      pages: [
        ...
        { text:`<span class='player-quote'>"Very well."</span>` },
        { text:`<span class='player-quote'>"I will make you my minions."</span>` },
        { text:`<span class='player-quote'>"You may call me {{P::character.title}}, and I will rule both over you and this keep."</span>` },
