Event.build('great-hall-talk-to-rat-chief', {
  ...
  stages:[{
    pages: [
      ...
      { minionSpeaker:'{{R::character.firstName}}', text:`Grinning broadly {{R::gender.he}} adds, <span class='minion-quote'>"We make more."</span>` },
      ...
      { minionSpeaker:'{{R::character.firstName}}', text:`{{R::gender.He}} nods excitedly, <span class='minion-quote'>"Yes yes. {{P::character.title}} kills rats and gets strong."</span>` },
