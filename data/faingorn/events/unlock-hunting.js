  ...
  stages:[{
    pages:[
      { text:`There, now that I've made a simple sling I can send {{C::character.firstName}} off to hunt some small
          game. They won't take down a deer or anything with it, but some rabbits would be tasty. Having a steady
          supply of fur and hide would be nice as well, and perhaps some day I'll start tanning leather.` },
