Event.build('magic-practice-1-1', {
  ...
  stages:[{
    pages:[
      { text:`I find a comfortable place to sit on the pile of hides and fur that has been serving as my bed.` },
      ...
      { text:`I can <i>feel</i> that they're hard and cool to the touch.` },
      { text:`I can <i>feel</i> the waning heat of the embers from last night's fire, still smoldering in the fireplace.` },
      { text:`That's&hellip; about the extend of it though.` },
      { text:`I'm still weak.` },
