Event.build('journal-1', {
  ...
  stages:[{
    pages:[
      ...
      { text:`It's in remarkable condition as well, especially considering that it's been locked in a drawer for who knows how long.` },
      ...
      { text:`I crack it open to the first page.` },
      ...
      { text:`They did have to spend a week or so searching for the place, even so&hellip;` },
      ...
      { text:`=== TODO: Dialog where you can rename the keep ===` },
