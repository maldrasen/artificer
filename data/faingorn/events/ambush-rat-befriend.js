  ...
  stages:[{
    pages:[
      ...
      { text:`I briefly consider asking {{him}} all the very basics; Where are we? What are you? But then, perhaps it
              wouldn't be wise to reveal that I have absolutely no memory or know really anything at all about where we
              are.` },
      ...
      { actorSpeaker:'R', text:`"This one is {{R::character.firstName}} {{R::character.lastName}} of the Deep Hole
              Scaven."` },
      { text:`{{His}} name is a barely pronounceable sequence of squeaks. Scaven though, that sounds familiar
              somehow.` },
      { playerSpeaker:true, text:`"Why are you here? This place is abandoned, or do you and your Deep Holes live
              here?"` },
      ...
      { text:`I wrack my brain, trying to remember anything I could about the scaven, their society, what motivates
              them?` },
      { text:`Nothing.` },
      { text:`I'm going to have to play this by ear and hope for the best. It's obvious that they live in some sort of
              tribal society. Given the state of {{his}} clothing I can only guess that overall they're not doing that
              well.` },
      ...
      { playerSpeaker:true, text:`"Well, it would seem you are in luck then," I say, "I have come here to claim this
              keep as my own. Everything within this place now belongs to me. I have need of servents though. I would
              like for you to return to your chief and let him know that a powerful wizard is now the
              {{P::character.title}} of this keep."` },
      ...
      { text:`{{He}} looks me up and down somewhat doubtfully, noting that I'm dressed in nothing but some stolen
              furs. To make my point, I reach out towards the dry wood in the fireplace and with a dramatic hand motion
      ...
      { text:`The scaven sprints from the room, running on all fours. As soon as {{he}} leaves though I collapse into a
              nearby chair. I'm panting, sweating. Heh, some powerful wizard, I can barely use magic at all without
              almost collapsing.` },
