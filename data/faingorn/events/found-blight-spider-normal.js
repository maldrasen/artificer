Event.build('found-blight-spider-normal', {
  ...
  stages:[{
    pages:[
      ...
      { requires:`minion(R).has-cock`, text:`{{C::gender.His}} massively swollen balls have completely ripped open in places, resulting in them being covered in numerous lesions and sores, all weeping a black viscous pus.` },
      { requires:`minion(R).no-cock`, text:`{{C::gender.His}} massively swollen pussy lips have completely ripped open in places, resulting in them being covered in numerous lesions and sores, all weeping a black viscous pus.` },
      ...
      { requires:`minion(R).has-cock`, text:`I nod to the rat and wave {{C::gender.him}} off, finally allowing {{C::gender.him}} to scurry out of my presence so that {{C::gender.he}} can go and tend to {{C::gender.his}} sore balls.` },
      { requires:`minion(R).no-cock`, text:`I nod to the rat and wave {{C::gender.him}} off, finally allowing {{C::gender.him}} to scurry out of my presence so that {{C::gender.he}} can go and tend to {{C::gender.his}} sore pussy.` },
    ]
  }],
