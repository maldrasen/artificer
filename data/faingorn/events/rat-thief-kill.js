  ...
  stages:[{
    pages:[
      { text:`I roughly slam {{him}} against the wall. {{His}} head impacts the stone with a dull thud, knocking
          {{him}} out for now.` },
      { text:`I pick {{his}} crumpled body off the stone floor and throw {{him}} over my shoulder. Now, what shall I do
          with {{him}}? I really only need {{his}} body to serve as a warning to others, so I could make it quick.` },
