Event.build('journal-2', {
  ...
  stages:[{
    pages:[
      ...
      { text:`By his estimation, by the time he and Wren found the place, it had been abandoned for at least a thousand years.` },
      ...
      { text:`I have a nagging sensation that a building shouldn't be that old, but how old should a building be?` },
      ...
      { text:`&hellip;` },
      { text:`He and Wren encountered a warren of scaven here as well, early on in their explorations.` },
      ...
      { text:`Malcolm would kill the scaven on sight, in increasingly brutal and painful ways; in order to train them, he writes, not to venture into the keep.` },
      { text:`He lavishes over the details in all the ways he finds to end them.` },
      { text:`That might explain why they reacted to me with such fear when they first saw me.` },
      { text:`Other than killing scaven and sealing away their warrens he and Wren spend the next several weeks making the keep as livable as is possible.` },
      ...
      { text:`Such an investigation might take years of careful study, and as a nobleman who was accustomed to a certain level of luxury, he wasn't about to spend that time simply camping.` },
      ...
      { text:`Knowing their entire story may be of more value than jumping ahead in any case.` },
