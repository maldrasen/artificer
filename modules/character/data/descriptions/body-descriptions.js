...
BodyDescription.build({ species:'elf',
  includes:['height-weight'],
  d: `{{His}} {{C::species.elven}} body is {{C::body.fiveFeetTenInches}} tall, weighs {{C::body.fiftyPounds}}.`
});

BodyDescription.build({ species:'elf', requires:['minion(C).is-male','minion(C).body.physique.below-average'],
  includes:['skin-color'],
  d: `{{He}} has a thin but unmistakably masculine {{C::species.elven}} body with {{C::body.skinColor}} skin.`
});

BodyDescription.build({ species:'elf', requires:['minion(C).is-not-male','minion(C).body.physique.feeble'],
  includes:['skin-color'],
  d: `{{He}} is very thin with a lithe and flexible looking body with {{C::body.skinColor}} skin.`
});

BodyDescription.build({ species:'elf', requires:['minion(C).body.physique.below-average','minion(C).body.height-short-for-species'],
  includes:['height-weight'],
...
BodyDescription.build({ species:'elf', requires:['minion(C).body.physique.below-average','minion(C).body.height-average-for-species'],
  includes:['skin-color'],
  d: `{{His}} graceful {{C::species.elven}} body is slender and a little fragile looking with {{C::body.skinColor}} skin.`
});

BodyDescription.build({ species:'elf', requires:['minion(C).body.physique.below-average','minion(C).body.height-tall-for-species'],
  includes:['height-weight'],
...
BodyDescription.build({ species:'elf', requires:['minion(C).is-male','minion(C).body.physique.above-average'],
  includes:['skin-color'],
  d: `{{He}}'s a strong looking {{C::species.elf}} with hard well defined muscles rippling under {{his}}
      {{C::body.skinColor}} skin.`
});

BodyDescription.build({ species:'elf', requires:['minion(C).is-male','minion(C).body.physique.far-above-average'],
  includes:['skin-color'],
...
BodyDescription.build({ species:'furry',
...
BodyDescription.build({ species:'furry', requires:['minion(C).is-male','minion(C).body.physique.below-average'],
  includes:['fur-color'],
  d: `{{He}} has a thin but unmistakably masculine {{C::species.elven}} body with {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'furry', requires:['minion(C).is-not-male','minion(C).body.physique.feeble'],
  includes:['fur-color'],
  d: `{{He}} is very thin with a lithe and flexible looking body covered in {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'furry', requires:['minion(C).body.physique.below-average','minion(C).body.height-short-for-species'],
  includes:['height-weight'],
...
BodyDescription.build({ species:'furry', requires:['minion(C).body.physique.below-average','minion(C).body.height-average-for-species'],
  includes:['fur-color'],
  d: `{{His}} slender {{C::species.elven}} body is covered with {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'furry', requires:['minion(C).body.physique.below-average','minion(C).body.height-tall-for-species'],
  includes:['height-weight'],
  d: `{{His}} body is tall and willowy, very thin and fragile looking while also being taller than most other
      {{C::species.elves}}. {{He}} is {{C::body.fiveFeetTenInches}} tall but only weighs {{C::body.fiftyPounds}}.`
});

BodyDescription.build({ species:'furry', requires:['minion(C).is-male','minion(C).body.physique.above-average'],
  includes:['fur-color'],
  d: `{{He}}'s a strong looking {{C::species.elf}} with hard well defined muscles rippling under {{his}}
      {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'furry', requires:['minion(C).is-male','minion(C).body.physique.far-above-average'],
  includes:['fur-color'],
  d: `{{He}}'s a very strong and masculine {{C::species.elf}} with rock hard cords of muscle rippling under {{his}}
      {{C::body.furColor}} fur.`
});
...
BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.average','minion(C).body.height-short-for-species'],
  includes:['fur-color','height-weight'],
...
BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.average','minion(C).body.height-tall-for-species'],
  includes:['fur-color'],
  d: `The goat man is taller than most other caprians at {{C::body.fiveFootTenInches}}. {{He}} weighs
      {{C::body.fiftyPounds}}, has thick {{C::body.furColor}} fur, and a small goat tail.`
});

BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.above-average'],
  includes:['fur-color'],
  d: `{{He}}'s a strong looking goat with well defined muscles under {{his}} {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.above-average','minion(C).body.height-short-for-species'],
  includes:['fur-color'],
  d: `{{He}}'s a short but strong looking goat with well defined muscles under {{his}} {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.above-average','minion(C).body.height-tall-for-species'],
  includes:['fur-color'],
  d: `{{He}}'s a tall and strong looking goat with well defined muscles under {{his}} {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.far-above-average'],
  includes:['fur-color'],
  d: `{{He}}'s a very muscular looking goat with hard rippling muscles under {{his}} {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.far-above-average','minion(C).body.height-short-for-species'],
  includes:['fur-color'],
  d: `{{He}}'s a very stocky and muscular looking goat with hard rippling muscles under {{his}} {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).body.physique.far-above-average','minion(C).body.height-tall-for-species'],
  includes:['fur-color'],
...
BodyDescription.build({ species:'caprien', requires:['minion(C).is-not-male'],
  includes:['height-weight'],
...
BodyDescription.build({ species:'centaur', requires:['minion(C).is-male','minion(C).body.physique.above-average'],
...
BodyDescription.build({ species:'centaur', requires:['minion(C).is-male','minion(C).body.physique.far-above-average'],
  includes:['skin-color'],
...
BodyDescription.build({ species:'dragon', requires:[],
  includes:['height-weight'],
...
BodyDescription.build({ species:'dryad', requires:[],
  includes:['height-weight','fur-color'],
...
BodyDescription.build({ species:'kobold', requires:[],
  includes:['height-weight'],
...
BodyDescription.build({ species:'naga', requires:[],
  includes:['height-weight'],
...
BodyDescription.build({ species:'scaven', requires:[],
  includes:['height-weight'],
  d: `{{His}} small lythe body is {{C::body.fiveFootTenInches}} tall, and {{he}} weighs {{C::body.fiftyPounds}}.`
});

BodyDescription.build({ species:'scaven', requires:['minion(C).body.height-average-for-species'],
  includes:['fur-color'],
  d: `{{His}} rat-like body is covered in {{C::body.furColor}} fur.`
});

BodyDescription.build({ species:'scaven', requires:['minion(C).body.height-short-for-species'],
  includes:['height-weight'],
  d: `At {{C::body.fiveFootTenInches}} tall {{he}}'s even smaller than most scaven and only weighs {{C::body.fiftyPounds}}.`
});

BodyDescription.build({ species:'scaven', requires:['minion(C).body.height-tall-for-species'],
  includes:['height-weight'],
...
BodyDescription.build({ species:'selkie', requires:[],
  includes:['fur-color'],
...
BodyDescription.build({ species:'goblin', requires:[], d:`(TODO: Goblin Bodies)` });
BodyDescription.build({ species:'ogre', requires:[], d:`(TODO: Ogre Bodies)` });

// === Incubus Bodies ===
// TODO: And while we're at it, the same is probably true for demons who will
//       have a bunch of unusual and demonic features.

BodyDescription.build({ species:'incubus', requires:[], d:`(TODO: Incubus Bodies)` });
BodyDescription.build({ species:'succubus', requires:[], d:`(TODO: Succubus Bodies)` });
