...
// // --- Size Specific ---
//
// Description.buildTits({ conditions:['minion(C).tits.zero'],
...
// });
//
// Description.buildTits({ requires:['minion(C).tits.tiny'],
...
// // --- Shape Specific ---
//
// Description.buildTits({ requires:['minion(C).tits.perky'], conditions:['minion(C).is-scaven'],
...
// });
//
// Description.buildTits({ requires:['minion(C).tits.conical'], conditions:['minion(C).is-scaven'],
...
// // =====================
//
// Description.buildTits({ conditions:['minion(C).is-scaven'],
...
// // --- Size Specific ---
//
// Description.buildTits({ conditions:['minion(C).is-scaven','minion(C).tits.zero'],
//   d: `{{C::character.firstName}} has a completely flat chest. {{C::gender.His}} chest is lean and muscular and could
...
// });
//
// Description.buildTits({ requires:['minion(C).tits.tiny'], conditions:['minion(C).is-scaven'],
...
// });
//
// Description.buildTits({ requires:['minion(C).tits.tiny','minion(C).nipples.huge'], conditions:['minion(C).is-scaven'],
