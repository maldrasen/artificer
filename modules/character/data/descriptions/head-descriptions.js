...
HeadDescription.build({ d:`` });

// == Masculine Capriens ===
// Capriens specifically have goat headed males, but elven faced females.

HeadDescription.build({ species:'caprien', requires:['minion(C).is-male'],
...
HeadDescription.build({ species:'caprien', requires:['minion(C).is-male','minion(C).face.soft'],
  d: `{{His}} boyish face is distinctly goat shaped and crowned with two {{C::body.ramHorns}}.`
});

// === Feminine Capriens ===

HeadDescription.build({ species:'caprien', requires:['minion(C).is-not-male'],
  includes:['hair-color'],
...
HeadDescription.build({ species:'caprien', requires:['minion(C).is-not-male','minion(C).face.soft'],
  includes:['eye-color','hair-color'],
...
HeadDescription.build({ species:'caprien', requires:['minion(C).is-not-male','minion(C).face.hard'],
  includes:['eye-color','hair-color'],
...
HeadDescription.build({ species:'dragon',
  d: `{{He}} has a distincly dragon-shaped head topped with a long pair of ridged backswept horns.`
});

HeadDescription.build({ species:'dragon', requires:['minion(C).face.hard'],
...
HeadDescription.build({ species:'dragon', requires:['minion(C).face.soft'],
...
HeadDescription.build({ species:'dryad',
  includes:['hair-color'],
...
HeadDescription.build({ species:'dryad', requires:['minion(C).face.hard'],
  includes:['eye-color','hair-color'],
...
HeadDescription.build({ species:'dryad', requires:['minion(C).face.soft'],
  includes:['eye-color','hair-color'],
...
HeadDescription.build({ species:'equian',
...
HeadDescription.build({ species:'equian', requires:['minion(C).face.hard','minion(C).is-male'],
  includes:['eye-color','fur-color','hair-color'],
...
HeadDescription.build({ species:'kobold',
  includes:['scale-color'],
...
HeadDescription.build({ species:'kobold', requires:['minion(C).face.hard'],
  includes:['eye-color','scale-color'],
...
HeadDescription.build({ species:'kobold', requires:['minion(C).face.soft','minion(C).face.at-least-average'],
  includes:['eye-color','scale-color'],
...
HeadDescription.build({ species:'lupin',
  includes:['fur-color'],
...
HeadDescription.build({ species:'lupin', requires:['minion(C).face.hard'],
  includes:['fur-color'],
  d: `{{He}} has a savage, feral looking wolf head covered in coarse {{C::body.furColor}} fur.`
});

HeadDescription.build({ species:'lupin', requires:['minion(C).face.soft'],
  includes:['eye-color','fur-color'],
...
HeadDescription.build({ species:'minotaur', requires:['minion(C).is-male'],
  includes:['eye-color','fur-color','hair-color'],
...
HeadDescription.build({ species:'minotaur', requires:['minion(C).is-male','minion(C).face.soft'],
  includes:['fur-color','hair-color'],
...
HeadDescription.build({ species:'minotaur', requires:['minion(C).is-not-male'],
  includes:['eye-color','fur-color','hair-color'],
...
HeadDescription.build({ species:'minotaur', requires:['minion(C).is-not-male','minion(C).face.soft'],
  includes:['fur-color','hair-color'],
  d: `{{His}} {{C::body.furColor}} furred head is distinctly cow-like and crowned with two {{C::body.ramHorns}}.
      A shaggy tuft of {{C::body.hairColor}} hair grows out from between {{his}} horns.`
});

HeadDescription.build({ species:'minotaur', requires:['minion(C).face.hard'],
  includes:['eye-color','hair-color'],
...
HeadDescription.build({ species:'naga', requires:['minion(C).face.plain'],
  includes:['scale-color','eye-color'],
...
HeadDescription.build({ species:'naga', requires:['minion(C).face.hard'],
  includes:['scale-color','eye-color'],
...
HeadDescription.build({ species:'naga', requires:['minion(C).face.soft'],
  includes:['eye-color'],
...
HeadDescription.build({ species:'naga', requires:['minion(C).face.exotic'],
  includes:['scale-color','eye-color'],
...
HeadDescription.build({ species:'neko',
...
HeadDescription.build({ species:'scaven',
  includes:['eye-color'],
  d: `The scaven has a face like a rat with beady {{C::body.eyeColor}} eyes.`
});

HeadDescription.build({ species:'scaven', requires:['minion(C).face.at-least-average'],
  includes:['eye-color'],
...
HeadDescription.build({ species:'scaven', requires:['minion(C).face.below-average'],
  includes:['fur-color'],
...
HeadDescription.build({ species:'selkie',
  includes:['eye-color','fur-color'],
...
HeadDescription.build({ species:'viera',
  includes:['eye-color','hair-color','fur-color'],
