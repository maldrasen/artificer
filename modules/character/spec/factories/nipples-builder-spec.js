describe('NippleBuilder', function() {
  ...
  describe('build', function() {
    ...
    it("doesn't give nipples to Kobolds", function(done) {
      MinionBuilder.buildMinion({ species:'kobold', gender:'female' }).then(character => {
        character.getNipples().then(nipples => {
    ...
    it('randomizes male nipples', function(done) {
      MinionBuilder.buildMinion({ species:'elf', gender:'male' }).then(character => {
        character.getNipples().then(nipples => {
    ...
    it('randomizes female nipples', function(done) {
      MinionBuilder.buildMinion({ species:'elf', gender:'female' }).then(character => {
        character.getNipples().then(nipples => {
          expect(nipples.count).to.equal(1);
          expect(nipples.length).to.be.within(1,5);
    ...
    it('builds puffy nipples', function(done) {
      MinionBuilder.buildMinion({ species:'elf', gender:'female', nipples:{ shape:'puffy' }}).then(character => {
        character.getNipples().then(nipples => {
          expect(nipples.width).to.be.within(18,55);
    ...
    it('builds inverted nipples', function(done) {
      MinionBuilder.buildMinion({ species:'elf', gender:'female', nipples:{ shape:'inverted' }}).then(character => {
        character.getNipples().then(nipples => {
          expect(nipples.width).to.be.within(18,55);
    ...
    it('builds star shaped nipples', function(done) {
      MinionBuilder.buildMinion({ species:'elf', gender:'female', nipples:{ shape:'star' }}).then(character => {
        character.getNipples().then(nipples => {
    ...
    it('builds star heart nipples', function(done) {
      MinionBuilder.buildMinion({ species:'elf', gender:'female', nipples:{ shape:'heart' }}).then(character => {
        character.getNipples().then(nipples => {
          expect(nipples.width).to.be.within(38,105);
    ...
    it('builds teats', function(done) {
      MinionBuilder.buildMinion({ species:'minotaur', gender:'female' }).then(character => {
        character.getNipples().then(nipples => {
