...
//     CharacterBuilder.build({ firstName:'X', species:'dragon', gender:'futa' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'elf', body:{ height:1800 }}).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'elf', body:{ skinColor:'red', skinShade:3 }}).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'dryad' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'lupin', body:{ furColor:'gray', furShade:1 }}).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'caprien', gender:'male' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'caprien', gender:'female' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'dragon', body:{ scaleColor:'purple' }}).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'naga' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'neko', gender:'futa' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'elf', body:{ hairColor:'purple' }}).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'dark-elf' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'minotaur' }).then(character => {
//       character.getBody().then(body => {
...
//     CharacterBuilder.build({ firstName:'X', species:'elf' }).then(character => {
//       character.getBody().then(body => {
//         expect(body.hairColor).to.exist;
...
//     CharacterBuilder.build({ firstName:'X', species:'centaur' }).then(character => {
//       character.getBody().then(body => {
