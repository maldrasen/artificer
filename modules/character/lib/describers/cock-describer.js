global.CockDescriber = class CockDescriber {
  ...
  async cockDescription() {
    let description = await CockDescription.select(this.context);
  ...
  sheathDescription() {
    ...
    return Random.from([
      `{{His}} cock emerges from a {{C::cock.furrySheath}} tucked between {{his}} legs.`,
      `{{His}} cock lies tucked within a {{C::cock.furrySheath}}.`,
      `The {{C::body.skinColor}} shaft emerges from a {{C::cock.furrySheath}} tucked between {{his}} legs.`,
    ]);
  }
  ...
  ballsDescription() {
    ...
    if (this.cock.sheath) { return Random.from([
      ...
      `{{His}} {{C::balls.big}} {{testicles}} each measure {{C::balls.twoInches}} across, tucked in a tight
       {{C::balls.apple}} sized {{ballsack}} hanging under {{his}} {{C::cock.furrySheath}}.`
    ]); }
