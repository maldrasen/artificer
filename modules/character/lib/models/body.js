...
global.Body = class Body extends Model {
  ...
  get convertedHeight() { return ConversionUtility.milliToInches(this.height); }
  get description() { return `${this.faceDescription} ${this.bodyDescription}`; }

  // Both finger and fist sizes are entirely dependent on height.
  get fistWidth()   { return Math.round(this.height*(86/1750)); }
  get fingerWidth() { return Math.round(this.height*(18/1750)); }
  ...
  // sized elf.
  get heightIsShort()    { return this.convertedHeight < 60 } // Under 5 feet
  get heightIsTall()     { return this.convertedHeight > 78 } // Over 6.5 feet.
...
Body.FaceTypes = FACE_TYPES;

Database.registerModel(Body);
